...
?>
  ...
  <section class="inner-cap service-detail-cp">
  ...
  <section class="services-cols py-3">
    <div class="container px-4 py-5">
      <?php 
    $expert = get_post(132); 
  ?>       
      <div class="row d-flex align-items-center justify-content-center ">
        <div class="col-sm-12 col-lg-9 text-center">
          ...
          <p class="mb-3 text-white mb-5 pb-5"><?php echo $expert->post_content;?></p>
        </div>       
      </div>
      <div class="row row-cols-lg-6 pt-5 service-row">
        <hr class="structure" />
        <?php if( have_rows('process', 132) ): $i=1;?>
    <?php while( have_rows('process', 132) ): the_row(); ?>
        <div class="process col mb-0 mb-2">
          <button class="c<?php echo $i?>" data-tooltip="<?php the_sub_field('description'); ?>"><span><?php the_sub_field('title'); ?></span></button>
        </div>
        <?php $i++; endwhile; ?>
          <?php endif; ?>
      </div>
